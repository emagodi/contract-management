...
import { 
  EyeIcon, DocsIcon, ArrowUpIcon, DownloadIcon, TrashBinIcon, PencilIcon,
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={7} className="px-5 py-8 text-center text-gray-500">No requisitions found.</TableCell>
                  </TableRow>
                ) : (
                  pagedItems.map((r) => (
