    ...
    <div>
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 shadow-theme-xs dark:border-white/[0.05] dark:bg-white/[0.03]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-white/[0.05] gap-4">
          <div>
            <p className="font-semibold text-gray-800 text-theme-sm dark:text-white/90">PROCUREMENT QUEUE</p>
          </div>
          ...
          <div className="min-w-[900px]">
            <Table>
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {loading ? (
                  <TableRow>
                    <TableCell className="px-5 py-4" colSpan={8}>Loading...</TableCell>
                  </TableRow>
                ) : error ? (
                  <TableRow>
                    <TableCell className="px-5 py-4 text-red-600" colSpan={8}>{error}</TableCell>
                  </TableRow>
                ) : pagedItems.length === 0 ? (
                  <TableRow>
                    <TableCell className="px-5 py-4" colSpan={8}>No requisitions</TableCell>
                  </TableRow>
                ) : (
                  pagedItems.map((r) => (
                    <TableRow key={r.id} className="hover:bg-blue-50/50 transition-colors">
                      ...
                      <TableCell className="px-5 py-4 text-start">
                        <div className="flex items-center gap-2">
                          <button 
                            onClick={() => router.push(`/requisitions/procurement/${r.id}`)} 
                            className="p-1 rounded-md text-sky-600 hover:bg-sky-50 hover:text-sky-700 transition-colors focus:outline-none focus:ring-1 focus:ring-sky-200 inline-flex items-center justify-center"
                            title="View Details"
                          >
                          ...
                          <button 
                            ...
                            className="p-1 rounded-md text-orange-600 hover:bg-orange-50 hover:text-orange-700 transition-colors focus:outline-none focus:ring-1 focus:ring-orange-200 inline-flex items-center justify-center"
